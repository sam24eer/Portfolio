...
export default function HobbyGallery() {
  ...
  const visibleCount = Math.min(9, hobbyPhotos.length);
      ...
      <div className="container-xl">
        ...
        <div className="glass rounded-2xl p-4 md:p-5">
          <div className="overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <div className="grid h-[420px] min-w-[1120px] grid-cols-5 grid-rows-3 gap-4 md:h-[460px]">
              {visiblePhotos.map((photo, idx) => {
                ...
                return (
                  <motion.button
                    ...
                    whileHover={{ y: -3 }}
                    className={`group focus-ring relative overflow-hidden rounded-xl border border-line bg-panel text-left ${layout[idx] ?? ''}`}
                  >
                    <img
