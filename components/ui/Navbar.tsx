...
export default function Navbar() {
  ...
  return (
    <div className="fixed inset-x-0 top-2.5 z-50 px-2 md:top-4 md:px-3">
      <div className="mx-auto flex w-fit max-w-full items-center gap-0.5 rounded-full border border-line/70 bg-panel/85 px-1.5 py-1.5 shadow-lg backdrop-blur-md max-[430px]:gap-0.5 max-[430px]:px-1.5 max-[430px]:py-1.5 max-[430px]:scale-[0.94] max-[430px]:origin-top max-[390px]:scale-[0.9] sm:gap-1 sm:px-2 sm:py-2">
        {navItems.map((item) => {
          ...
          return (
            <a
              ...
              className={`focus-ring whitespace-nowrap rounded-full px-1.5 py-1 text-[11px] font-medium transition max-[430px]:px-1.5 max-[430px]:text-xs sm:px-3 sm:py-1.5 sm:text-xs md:px-4 ${
        ...
        <button
          type="button"
          onClick={toggleTheme}
          className="focus-ring ml-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-line bg-base text-text transition hover:border-brand/50 max-[430px]:ml-0 max-[430px]:h-8 max-[430px]:w-8 sm:ml-1 sm:h-8 sm:w-8"
